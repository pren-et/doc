...
\fi
Die Firmware des Boards erfüllt mehrere Aufgaben. Während dem Anfahren realisiert
diese die Zwangskommutierung und im Nennbetrieb, regelt diese die Drehzahl des
Motors. Sobald der Motor in Betrieb ist, wir die Kommutierung mittes der Interrupts
realisiert.
\ifSTANDALONE
\subsection{Takt}
\fi
