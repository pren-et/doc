...
Blockschema in der Abbildung \ref{abb:BlockschemaRegler} abgebildet. Je nach 
...
Filter mit garantierter endlichen Antwort auf ein Impuls} gefiltert. Der 
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[node distance=2.0cm]
        ...
        \node (ist)     [right of=feedback]                 {Istwert Drehzahl};
